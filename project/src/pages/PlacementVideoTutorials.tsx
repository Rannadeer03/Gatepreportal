...
const placementSubjectIcons: Record<string, React.ReactNode> = {
    'Technical Interview Prep': <Code className="w-6 h-6" />,
    'HR & Behavioral': <MessageSquare className="w-6 h-6" />,
    'Aptitude & Reasoning': <Brain className="w-6 h-6" />,
    'Resume Building': <Briefcase className="w-6 h-6" />,
    'Company Insights': <TrendingUp className="w-6 h-6" />,
    'Coding Challenges': <Code className="w-6 h-6" />
};

const PlacementVideoTutorials: React.FC = () => {
    ...
    const fetchTutorials = async () => {
        try {
            setLoading(true);
            // Fetch from academic_video_tutorials table filtering by placement-related subjects
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-red-50 to-pink-100 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="mt-4 text-gray-600 font-medium">Loading placement video tutorials...</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-red-50 to-pink-100">
            <div className="container mx-auto px-4 py-8">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            <div className="flex items-center gap-2">
                                <h1 className="text-3xl font-bold text-gray-900">Placement Video Tutorials</h1>
                                <Briefcase className="w-6 h-6 text-pink-600" />
                            </div>
                            <p className="text-gray-600 mt-1">Master placement skills with expert video tutorials</p>
                        </div>
                    </div>
                </div>
                ...
                {/* Eco Tip */}
                <VideoEcoTip>
                    Learn placement strategies online — reduce your paper usage and prepare smarter!
                </VideoEcoTip>
                    ...
                    <div className="flex flex-col md:flex-row gap-4">
                        <div className="flex-1">
                            <div className="relative">
                                ...
                                <input
                                    type="text"
                                    placeholder="Search placement tutorials by topic..."
                                    value={searchQuery}
                                    onChange={(e) => setSearchQuery(e.target.value)}
                                    className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-pink-400 focus:border-pink-400 transition-all"
                                />
                            </div>
                        </div>
                        <div className="flex items-center space-x-2">
                            ...
                            <select
                                ...
                                className="px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-pink-400 focus:border-pink-400 transition-all"
                            >
                            ...
                            {subjects.map(subject => {
                                ...
                                return (
                                    <VideoSubjectCard
                                        ...
                                        icon={placementSubjectIcons[subject] || <BookOpen className="w-6 h-6" />}
                    ...
                    <div className="mb-8">
                        <div className="flex items-center justify-between mb-4">
                            <h2 className="text-2xl font-bold text-gray-900">
                                {selectedSubject ? `${selectedSubject} Videos` : 'All Placement Videos'}
                            </h2>
                            {selectedSubject && (
                                <Button
                                    variant="outline"
...
export default PlacementVideoTutorials;
