...
const dashboardOptions = [
  {
    ...
    color: 'bg-[#F87171]/10',
    action: (navigate: any) => navigate('/take-test-page'),
  },
  {
    id: 'study-materials',
    ...
    color: 'bg-[#EC4899]/10',
    action: (navigate: any) => navigate('/study-materials'),
  },
  {
    id: 'assignments',
    title: 'Assignments',
    ...
    color: 'bg-[#3B82F6]/10',
    action: (navigate: any) => navigate('/student/assignments'),
  },
  {
    id: 'test-results',
    title: 'Test Results',
    ...
    color: 'bg-[#22C55E]/10',
    action: (navigate: any) => navigate('/student-test-results'),
  },
  {
